...
public class ImageFakeBloom : MonoBehaviour
{
    ...
    private void UpdateGlow()
    {
        ...
        //TextureScale.Scale(blurTex, blurTex.width * 2, blurTex.height * 2);
        Sprite blurSprite = Sprite.Create(blurTex, new Rect(0, 0, blurTex.width, blurTex.height), _image.rectTransform.pivot);
